...
```{r, echo = FALSE, fig.cap= "Figure 1: Box plot showing effect of quantity of copper units added to feed and feed type on growth rate of chicks. Experiment created and run on vested Rshiny application (https://stats-uoa.shinyapps.io/vested/), virtual experiment 'Miracle grow for chooks'"}
